...
#OPTIONAL:
gmail_user = "test@gmail.com" #If you want the code to email you, make a gmail account and enable 'less secure apps' https://support.google.com/accounts/answer/6010255?hl=en
...
#REQUIRED:
authPassword = "H3r#1sAg00dP@ss!" #Choose a strong password value, something with letters, numbers, case, and characters. You will only ever have to enter this twice, so more complex the better.
